...
HD_PWD='C:/Users/USER/Desktop/cgj/cpu1/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu1.tcl -notrace
